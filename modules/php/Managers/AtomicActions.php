...
class AtomicActions
{
  ...
  static $classes = [
    ...
    FESTIVITY_CHECK_GENERATE_GOSSIP => FESTIVITY_CHECK_GENERATE_GOSSIP,
    FESTIVITY_SELECT_WINNING_SET => FESTIVITY_SELECT_WINNING_SET,
    FESTIVITY_CHOOSE_NEXT_FOILED_THREAT => FESTIVITY_CHOOSE_NEXT_FOILED_THREAT,
    LOG_PHASE => LOG_PHASE,
    FESTIVITY_TAKE_MATCHING_CUBES => FESTIVITY_TAKE_MATCHING_CUBES,
    FESTIVITY_FOIL_THREAT => FESTIVITY_FOIL_THREAT,
    FESTIVITY_FOIL_THREAT_ADD_TO_SAFE_PILE => FESTIVITY_FOIL_THREAT_ADD_TO_SAFE_PILE,
    END_OF_WEEK_REVEAL_THREATS => END_OF_WEEK_REVEAL_THREATS,
    END_OF_WEEK_SOCIETY_INVESTIGATES => END_OF_WEEK_SOCIETY_INVESTIGATES,
    END_OF_WEEK_CHECK_FOR_RAIDS => END_OF_WEEK_CHECK_FOR_RAIDS,
    ...
    EXAMINE_GOSSIP_PILE => EXAMINE_GOSSIP_PILE,
    PLACE_ENCOUNTER_TOKEN => PLACE_ENCOUNTER_TOKEN,
    FESTIVITY_BOTTLE_OF_GIN_CHECK => FESTIVITY_BOTTLE_OF_GIN_CHECK,
    FESTIVITY_USE_BOTTLE_OF_GIN => FESTIVITY_USE_BOTTLE_OF_GIN,
    ...
    FESTIVITY_KNOWN_THREAT_CHECK => FESTIVITY_KNOWN_THREAT_CHECK,
    FESTIVITY_PASS_AND_PLAY_COMMUNITY_CARD => FESTIVITY_PASS_AND_PLAY_COMMUNITY_CARD,
    NEWSPAPER_NOTICE => NEWSPAPER_NOTICE,
    USE_DOLL => USE_DOLL,
    USE_DOMINO => USE_DOMINO,
    USE_DRESS => USE_DRESS,
